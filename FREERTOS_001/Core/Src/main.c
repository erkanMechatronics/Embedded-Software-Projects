...
osThreadId NormalPriorityTHandle;
...
/* USER CODE BEGIN Header_StartNormalPriorityTask */
/**
* @brief Function implementing the NormalPriorityT thread.
* @param argument: Not used
* @retval None
*/
...
void StartNormalPriorityTask(void const * argument)
{
  ...
  /* USER CODE END StartNormalPriorityTask */
}
