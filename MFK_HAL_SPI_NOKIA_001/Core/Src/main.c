...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  LCD5110_PixelWrite(0,0,1);
	  LCD5110_PixelWrite(0,1,1);
	  LCD5110_PixelWrite(0,2,1);
	  LCD5110_PixelWrite(0,3,1);
	  LCD5110_PixelWrite(0,4,1);
	  LCD5110_PixelWrite(0,5,1);
	  LCD5110_PixelWrite(0,6,1);
