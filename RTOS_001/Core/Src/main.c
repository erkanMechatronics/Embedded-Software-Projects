...
int main(void)
{
  ...
  osThreadDef(SecondTask, StartSecondTask, osPriorityBelowNormal, 0, 128);
  SecondTaskHandle = osThreadCreate(osThread(SecondTask), NULL);

  /* definition and creation of ThirdTask */
  osThreadDef(ThirdTask, StartThirdTask, osPriorityAboveNormal, 0, 128);
